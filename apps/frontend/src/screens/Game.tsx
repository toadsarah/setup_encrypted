...
export const Game = () => {
  ...
  //web3
  const { contract, walletAddress, erc20Contract, } = useGlobalContext();

  const depositAmount = '1000000000000000000'
  const contractAddress = '0x4992CC2AC63ae8d76B585C7A63dcD3eAcf126e22'

  const handleStart = async () => {
    // console.log(erc20Contract)
    // const txApprove = await erc20Contract?.approve(contractAddress, ethers.utils.parseEther(depositAmount.toString()));
